...
const MembersForm = ({ member = null }) => {
  ...
  const schema = yup.object().shape({
    ...
    facebook: yup
      ...
      .required("Please, provide a facebook website for your social media."),
    instagram: yup
      .string()
      .matches(
        /((https?):\/\/)?(www.)?[a-z0-9]+(\.[a-z]{2,}){1,3}(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/,
      ...
      .required("Please, provide a instagram website for your social media."),
    linkedin: yup
      .string()
      .matches(
        /((https?):\/\/)?(www.)?[a-z0-9]+(\.[a-z]{2,}){1,3}(#?\/?[a-zA-Z0-9#]+)*\/?(\?[a-zA-Z0-9-_]+=[a-zA-Z0-9-%]+&?)?$/,
      ...
      .required("Please, provide a linkedin website for your social media."),
  });
