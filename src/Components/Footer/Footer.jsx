      ...
      <Container className="text-center">
        ...
        <Row className="justify-content-center align-items-center">
          ...
          <Col className="d-flex flex-column text-center">
            ...
            <Link to="/Testimonios" className="text-decoration-none text-white">
              Testimonios
            </Link>
          </Col>
          <Col className="d-flex flex-column text-center">
            <Link to="/Miembros" className="text-decoration-none text-white">
              Miembros
            </Link>
            <Link to="/Activities" className="text-decoration-none text-white">
              Actividades
            </Link>
            <Link
              to="/RegisterForm"
          ...
          <Col className="d-flex flex-column text-center">
            <a href={`https://` + orgData.facebook_url} target="_blank">
              <img
            ...
            <a href={`https://` + orgData.instagram_url} target="_blank">
              <img
                style={{ height: "45px", padding: "5px" }}
                src={instagramLogo}
                alt="instagram"
            ...
            <a href={`https://` + orgData.linkedin_url} target="_blank">
              <img
                style={{ height: "45px", padding: "5px" }}
                src={linkedinLogo}
                alt="linkedin"
